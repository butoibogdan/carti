...
<html lang="en">
    ...
    <head>
        ...
        <!-- Bootstrap Core CSS -->
        <link href="{{asset('FO/css/bootstrap.min.css')}}" rel="stylesheet">

        <!-- Custom CSS -->
        <link href="{{asset('FO/css/portfolio-item.css')}}" rel="stylesheet">
    ...
    <body>
        ...
        <!-- jQuery -->
        <script src="{{asset('FO/js/jquery.js')}}"></script>
