<div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        {!! Form::file('cover',  ['class' => 'form-control', 'id'=>'finput']) !!}
        {!! $errors->first('cover', '<p class="help-block">:message</p>') !!}
    </div>
</div><div class="form-group {{ $errors->has('author') ? 'has-error' : ''}}">
    {!! Form::label('author', 'Author', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::select('author', $authors ,$selectedauthor , ['class' => 'form-control', 'id'=>'select']) !!}
    ...
    <div class="col-md-6">
        {!! Form::select('tags[]',$taguri, $selectedtags , ['class' => 'form-control', 'multiple'=>true, 'id'=>'select']) !!}
